...
sql_create_table = f"CREATE TABLE IF NOT EXISTS {table_name} (id integer PRIMARY KEY AUTOINCREMENT, nome text NOT NULL UNIQUE, id_professor integer NOT NULL UNIQUE);"
